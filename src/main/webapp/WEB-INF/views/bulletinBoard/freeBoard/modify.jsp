            ...
            <main>
                <div class="write-form">
                    ...
                    <form action="/bulletinBoard/freeBoard/update.do" method="post">
                        ...
                        <input type="text" id="freeBoard-title" name="freeBoard-title" value="${freeBoard.freeBoardTitle}" required>
...
<!--                         <input type="password" id="freeBoard-password" name="freeBoard-password" required> -->
                        ...
                        <textarea id="freeBoard-content" name="freeBoard-content" rows="10" required>${freeBoard.freeBoardContent}</textarea>
