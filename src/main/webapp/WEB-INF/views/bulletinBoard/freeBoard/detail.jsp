...
<!--             <p class="post-details">작성자: 감스트 | 작성시간: 2023-06-06 10:30:00</p> -->
			<p class="post-details">
				<span>글번호 : ${freeBoard.freeBoardNo} | 작성자 : ${freeBoard.freeBoardWriter} | 작성 시간 : ${freeBoard.freeBoardDate}</span>
			</p>
            <div class="post-content">
              <img src="../../resources/images/postPhoto6.png" alt="포스트이미지"><br>
              <span>${freeBoard.freeBoardContent}</span>
            </div>
          </div>
          <div class="bottom">
            <p>추천 수  <span id="recommendCount">40</span></p>
            ...
            <a href="/bulletinBoard/freeBoard/update.do?freeBoardNo=${freeBoard.freeBoardNo}"><button>수정하기</button></a>
