        ...
        <div id="container">
            ...
            <main>
                <div class="write-form">
                    ...
                    <form action="/bulletinBoard/freeBoard/insert.do" method="post">
                        <label for="title">제목</label>
                        <input type="text" id="freeBoard-title" name="freeBoard-title" required>
...
<!--                         <input type="password" id="freeBoard-password" name="freeBoard-password" required> -->
                        ...
                        <textarea id="freeBoard-content" name="freeBoard-content" rows="10" required></textarea>
