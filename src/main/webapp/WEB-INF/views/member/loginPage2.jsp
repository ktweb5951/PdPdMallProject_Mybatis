                    ...
                    <div id="loginBox">
                        <form id="loginForm" action="#" method="post">
                            <div class="inputClass">
                                <input id="member-id" type="text" placeholder="아이디를 입력해 주세요." name="member-id" required>
                            </div>
                            <div class="inputClass">
                                <input id="member-pw" type="password" placeholder="비밀번호를 입력해 주세요." name="member-pw" required>
                            </div>
                            <div class="inputClass">
